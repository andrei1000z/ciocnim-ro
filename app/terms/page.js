    ...
    <main className="min-h-screen bg-[#0c0a0a] text-gray-200">
      <div className="max-w-2xl mx-auto px-4 py-12 space-y-8">
        ...
        <section className="space-y-4 text-sm text-gray-300 leading-relaxed">
          <h2 className="text-lg font-bold text-white mt-6">1. Descrierea serviciului</h2>
          ...
          <h2 className="text-lg font-bold text-white mt-6">2. Utilizarea serviciului</h2>
          ...
          <h2 className="text-lg font-bold text-white mt-6">3. Conținut generat de utilizatori</h2>
          ...
          <h2 className="text-lg font-bold text-white mt-6">4. Proprietate intelectuală</h2>
          ...
          <h2 className="text-lg font-bold text-white mt-6">5. Limitarea responsabilității</h2>
          ...
          <h2 className="text-lg font-bold text-white mt-6">6. Modificări</h2>
